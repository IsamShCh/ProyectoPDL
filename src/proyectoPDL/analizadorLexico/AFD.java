...
public class AFD {
	...
	public static void main(String[] args) {
		...
		System.out.println("Nos encontramos en  el  estado " + est + " y hemos leido  el  caracter " + carac
				+ " y nos corresponde irnos al estado " + x + " y realizar  la  accion " + y);
	...
	// public int estado(int estado, char caracter) throws
	// CaracterValidoNoEsperadoException, CaracterNoValidoException {
	// String key = String.valueOf(estado) + String.valueOf(caracter);
	// if (!tabla_estados.containsKey(key)) {
	...
	private void putExpTablaEstados(String val, String val2, int val3, boolean bol) {
		...
		// val = estado actual val2 = caracter leido val3 = estado siguiente bool= si
		// NOT.
